...
public class Guesser
{
   ...
   * it is "T" or "F", we have a valid reply. Return the String that you read
   * from the player.
   */
  private String getReply()
  {
    ...
    do
    {
      System.out.println("Write T(rue) or F(alse)");
      reply = System.console().readLine();

      if (reply.equalsIgnoreCase("t")
          || (reply.equalsIgnoreCase("f")))
      {
        break;
      }
      else
  ...
  private void answer(int guess,
                      int numberOfGuesses)
  {
    System.out.println("You were thinking about " + guess + " (took me "
